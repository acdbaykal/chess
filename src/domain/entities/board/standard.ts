...
export const STANDART_INITIAL_POSITION = createBoardFromList([
    ...
    [createSquare(D, _1), createPiece(PieceColor.White, PieceType.King)],
    [createSquare(E, _1), createPiece(PieceColor.White, PieceType.Queen)],
    ...
    [createSquare(D, _8), createPiece(PieceColor.Black, PieceType.King)],
    [createSquare(E, _8), createPiece(PieceColor.Black, PieceType.Queen)],
