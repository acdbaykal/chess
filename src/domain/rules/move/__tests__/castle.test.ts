...
describe('domain/rules/move/castle', () => {
    ...
    it('does not include short castle when the rook has moved', () => {
        const moveHistory: MoveHistory = createMoveHistory([ 
            createRegularMove(createSquare(E, _2), createSquare(E, _4)),
            createRegularMove(createSquare(D, _7), createSquare(D, _5)),
            createRegularMove(createSquare(E, _4), createSquare(D, _5)),
            createRegularMove(createSquare(D, _8), createSquare(D, _5)),
            createRegularMove(createSquare(B, _1), createSquare(C, _3)),
            createRegularMove(createSquare(D, _5), createSquare(E, _5)),
            createRegularMove(createSquare(G, _1), createSquare(E, _2)),
            createRegularMove(createSquare(C, _8), createSquare(G, _4)),
            createRegularMove(createSquare(D, _2), createSquare(D, _4)),
            createRegularMove(createSquare(E, _5), createSquare(H, _5)),
            createRegularMove(createSquare(F, _2), createSquare(F, _3)),
            createRegularMove(createSquare(G, _4), createSquare(F, _3)),
            createRegularMove(createSquare(G, _2), createSquare(F, _3)),
            createRegularMove(createSquare(H, _5), createSquare(F, _3)),
            createRegularMove(createSquare(H, _1), createSquare(G, _1)),
            createRegularMove(createSquare(B, _8), createSquare(C, _6)),
            createRegularMove(createSquare(C, _1), createSquare(F, _4)),
            createRegularMove(createSquare(A, _8), createSquare(C, _8)),
            createRegularMove(createSquare(F, _1), createSquare(G, _2)),
            createRegularMove(createSquare(F, _3), createSquare(H, _5)),
            createRegularMove(createSquare(G, _2), createSquare(C, _6)),
            createRegularMove(createSquare(B, _7), createSquare(C, _6)),
            createRegularMove(createSquare(E, _2), createSquare(G, _3)),
            createRegularMove(createSquare(C, _8), createSquare(A, _8)),
            createRegularMove(createSquare(G, _3), createSquare(H, _5))
        ]);
    ...
    it('does not include short castle when a bishop cuts the route', () => {
        const moveHistory: MoveHistory = createMoveHistory([
            createRegularMove(createSquare(E, _2), createSquare(E, _4)),
            createRegularMove(createSquare(E, _7), createSquare(E, _5)),
            createRegularMove(createSquare(F, _1), createSquare(C, _4)),
            ...
            createRegularMove(createSquare(G, _8), createSquare(F, _6)),
            createRegularMove(createSquare(F, _2), createSquare(F, _3)),
            createRegularMove(createSquare(H, _7), createSquare(H, _6))
        ]);
